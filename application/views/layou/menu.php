...
<?php  if( $this->session->userdata('tipo')==3 ) { ?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url();?>Cnomina/saldos_desc/"><i class="fa fa-circle-o"></i> Cargar Adelanto </a></li>
        ...
        <?php  if( $this->session->userdata('tipo')==5 ) { ?>
         ...
         <li class=" treeview active">
          ...
          <ul class="treeview-menu ">
            <li><a href="<?php echo base_url();?>Cadmin/"><i class="fa fa-circle-o"></i> Seguimiento pedidos </a></li>
            <li><a href="<?php echo base_url();?>/Ctaller/"><i class="fa fa-circle-o"></i> Panel cortes </a></li>

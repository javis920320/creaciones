...
<div class="col-xs-17"> <strong align='center'>Bienvenido a Creaciones Goretti</strong></div>
...
<button id='pdf' class=' hide btn '  data-toggle="modal" data-target="#asignar"><span class='glyphicon glyphicon-sum'></span>  Asignar proceso</button>

$('#tblusuarios').DataTable({
			...
			render:function(data,type,row){
					...
					return '<span class="pull-right">' +
                      ...
                      '    <li><a href="#" title="Enviar Pedido"  data-toggle="modal" data-target="#estado"  onClick="estadopedido(\''+row.idpedido+'\',\''+row.nombres+'\',\''+row.telefono+'\')"><i style="color:green;" class="glyphicon glyphicon-ban-circle"></i> Enviar Pedido</a></li>' +

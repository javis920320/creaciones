...
backup_tables('localhost','root','administrador9203','inscripcion_db');
...
function backup_tables($host,$user,$pass,$name,$tables = '*')
{
   ...
   //save file
   $handle = fopen('C:\Users\Administrador\Desktop\Documentos\db-backup-'.time().'-'.(md5(implode(',',$tables))).'.sql','w+');
